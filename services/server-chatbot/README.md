...
## Models
Custom LiteLLM model support
- Generation: Requires input of LiteLLM model string, and API key for the model into model, in API predict and predict stream API call
- If not provided the default system model is used
